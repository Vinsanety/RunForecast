  ...
  render() {
    return (
      <div className="weather-card-container">
        {(this.props.city || this.props.formHint) && (
          <Card className="weather-card">
            {!this.props.formHint && (
              <Grid container alignItems="center">
                <Grid item xs={12} sm={6}>
                  {this.props.city && (
                    <p className="weather-card-location">{this.props.city}</p>
                  )}
                ...
                <Grid item xs={12} sm={6} className="weather-card-meta-data">
                  ...
                  {this.props.windSpeed && (
                    <p>
                      <span className="weather-category">Wind Speed:</span>{" "}
                      {this.props.windSpeed}
                  ...
                  {this.props.city && (
                    <p>
                      <span className="weather-category">Cloudiness:</span>{" "}
                      {this.props.cloud}
                      <span className="measurement-unit">%</span>
                    </p>
                  )}
                  {this.props.sunrise && (
                    <p>
                      <span className="weather-category">Sunrise:</span>{" "}
                      {this.props.sunrise}{" "}
                      <Icon className="sunrise-icon">brightness_5</Icon>
                    </p>
                  )}
                  {this.props.sunrise && (
                    <p>
                      <span className="weather-category">Sunset:</span>{" "}
                      {this.props.sunset}{" "}
                      <Icon className="sunset-icon">brightness_4</Icon>
                    </p>
                  )}
                </Grid>
              </Grid>
            ...
            {this.props.error && (
              <p className="weather-card-error">{this.props.error}</p>
            )}
            {this.props.formHint && (
